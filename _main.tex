...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{descriptives }\OtherTok{\textless{}{-}}\NormalTok{ datos\_sim }\SpecialCharTok{\%\textgreater{}\%}\NormalTok{ psych}\SpecialCharTok{::}\FunctionTok{describe}\NormalTok{() }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{as\_tibble}\NormalTok{() }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{select}\NormalTok{(}\StringTok{"n"}\NormalTok{,}\StringTok{"min"}\NormalTok{,}\StringTok{"max"}\NormalTok{,}\StringTok{"mean"}\NormalTok{)}

\CommentTok{\# add stats to codebook }
\NormalTok{codebook02 }\OtherTok{\textless{}{-}} \FunctionTok{cbind}\NormalTok{(codebook02,descriptives)}
\NormalTok{codebook02}\SpecialCharTok{$}\NormalTok{min }\OtherTok{\textless{}{-}} \FunctionTok{round}\NormalTok{(codebook02}\SpecialCharTok{$}\NormalTok{min, }\DecValTok{2}\NormalTok{)}
\NormalTok{codebook02}\SpecialCharTok{$}\NormalTok{max }\OtherTok{\textless{}{-}} \FunctionTok{round}\NormalTok{(codebook02}\SpecialCharTok{$}\NormalTok{max, }\DecValTok{2}\NormalTok{)}
\NormalTok{codebook02}\SpecialCharTok{$}\NormalTok{mean }\OtherTok{\textless{}{-}} \FunctionTok{round}\NormalTok{(codebook02}\SpecialCharTok{$}\NormalTok{mean, }\DecValTok{2}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
